        ...
        <div id="deleteModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
            <div class="relative p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mt-3">¿Eliminar producto?</h3>
                        ...
                        <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }} hover:bg-gray-100 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex justify-center">
                                    <img src="{{ asset('storage/' . $producto->foto) }}" alt="{{ $producto->nombre }}" class="h-12 w-12 rounded-full object-cover aspect-square">
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex justify-center space-x-3">
                                    ...
                                    <!-- Eliminar -->
                                    <button type="button" onclick="openModal('{{ route('productos.destroy', $producto->id) }}')" class="text-red-500 hover:text-red-700 transition-colors duration-200" title="Eliminar">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="mb-4 md:mb-0">
                        <p id="resultCount" class="text-sm text-gray-500">
                            ...
                            a
                            <span class="font-medium text-gray-700">{{ min(10, count($productos)) }}</span>
                            de
