        ...
        <div class="card shadow-lg border-0 rounded-xl overflow-hidden mb-8 bg-white">
            ...
            <div class="card-header flex flex-col sm:flex-row justify-between items-start sm:items-center py-5 px-8 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-gray-200">
                <div class="flex items-center mb-3 sm:mb-0">
                    <i class="ri-edit-box-line text-2xl text-blue-600 mr-3"></i>
                ...
                <form action="{{ route('productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="flex flex-col items-start">
                            ...
                            <div class="mb-4 w-full">
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 rounded-md bg-gray-50">
                                    <img src="{{ asset('storage/' . $producto->foto) }}" alt="{{ $producto->nombre }}" class="h-32 object-contain">
                                </div>
                            </div>
                            <!-- Campo para nueva imagen -->
                            <div class="w-full">
                                <label for="foto" class="block text-sm font-medium text-gray-700 mb-1">Cambiar imagen</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <input type="text" name="nombre" id="nombre" value="{{ $producto->nombre }}" class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-4 pr-10 py-3 sm:text-sm border-gray-300 rounded-md" placeholder="Ej. Camiseta de algodón" required>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="precio" id="precio" value="{{ $producto->precio }}" class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 pr-12 py-3 sm:text-sm border-gray-300 rounded-md" placeholder="0.00" step="0.01" min="0" required>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="descripcion" name="descripcion" rows="6" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Describe las características, materiales, tallas disponibles, etc." required>{{ $producto->descripcion }}</textarea>
                            </div>
                    ...
                    <div class="pt-8">
                        <div class="flex justify-end space-x-4">
                            ...
                            <button type="submit" class="ml-3 inline-flex justify-center py-3 px-8 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150">
                                <i class="ri-save-2-line mr-2"></i> Actualizar Producto
                            </button>
                        </div>
                    </div>
                </form>
