...
@section('content')
    <div class="container mx-auto p-6">
        ...
        <div id="formulario_solicitud" class="hidden bg-white p-4 rounded-lg shadow-md">
            ...
            <input type="text" id="titulo" class="border p-2 w-full mb-3">

            <div class="grid grid-cols-3 gap-4" id="producto_fields">
                <div>
                    <label class="block font-semibold">Nombre del producto / servicio</label>
                    <input type="text" id="nombre" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Modelo / Tipo</label>
                    <input type="text" id="modelo" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Marca</label>
                    <input type="text" id="marca" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Cantidad</label>
                    <input type="text" id="cantidad" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Presupuesto aproximado para invertir</label>
                    <input type="text" id="presupuesto" class="border p-2 w-full mb-3">
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-4" id="servicio_fields">
                <div>
                    ...
                    <input type="text" id="tipo_solicitudServicio" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Descripción del servicio</label>
                    <input type="text" id="descripcion_servicio" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Presupuesto aproximado para invertir</label>
                    <input type="text" id="presupuesto_servicio" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label for="tipo_servicio" class="block font-semibold">Tipo de servicio:</label>
                    <select id="tipo_servicio" class="border p-2 w-full mb-3">
            ...
            <div class="grid grid-cols-3 gap-4" id="proveedor_fields">
                <div>
                    ...
                    <input type="text" id="trabajo" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Detalles del trabajo</label>
                    <input type="text" id="detalles" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Conocimientos deseados para el trabajo</label>
                    <input type="text" id="conocimientos" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Certificaciones / Cursos requeridos</label>
                    <input type="text" id="cursos" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label class="block font-semibold">Tiempo para implementar el trabajo</label>
                    <input type="text" id="tiempo" class="border p-2 w-full mb-3">
                </div>
                <div>
                    <label for="tipo_servicio" class="block font-semibold">Tipo de servicio:</label>
                    <select id="tipo_servicio" class="border p-2 w-full mb-3">
            ...
            <textarea id="descripcion" class="border p-2 w-full mb-3"></textarea>

            <label class="block font-semibold">Link Drive</label>
            <input type="text" id="link_drive" class="border p-2 w-full mb-3">
            ...
            <button class="bg-gray-500 text-white px-4 py-2 rounded mt-3" id="guardar_btn">Guardar</button>

            <!-- Modal de éxito (inicialmente oculto) -->
        <div id="modal_exito" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
