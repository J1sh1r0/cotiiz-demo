        ...
        <aside class="compact-items-sidebar bg-gradient-to-b from-gray-800 to-gray-900 text-white shadow-xl" id="sidebar">
            <div class="p-5">
                ...
                <div class="profile-box bg-gray-700 bg-opacity-50 rounded-lg border border-gray-600">
                    ...
                    <a href="{{ route('seleccion.perfil') }}"
                        class="text-blue-400 hover:text-blue-300 text-xs flex items-center mt-1.5 transition-colors">
                ...
                <nav class="space-y-1.5">
                    <a href="{{ route('dashboard') }}"
                       class="nav-item flex items-center rounded-lg transition-all duration-200 {{ Route::is('dashboard') ? 'bg-blue-600 text-white shadow-md' : 'hover:bg-gray-700 hover:text-white' }}">
                        ...
                        <!-- Menú para Empresa de prueba -->
                        @if (session('perfil') === 'empresa_prueba')
                            <a href="{{ route('empresa_prueba.solicitudes.seleccionar-tipo') }}"
                                class="nav-item flex items-center rounded-lg transition-all {{ Route::is('empresa_prueba.solicitudes.*') ? 'bg-blue-600 text-white' : 'hover:bg-gray-700 hover:text-white' }}">
                                <i class="fas fa-file-alt nav-icon text-center text-blue-300"></i>
                                <span class="ml-3">Solicitudes</span>
                            </a>
                            <a href="{{ route('empresa_prueba.solicitudes') }}"
                                class="nav-item flex items-center rounded-lg transition-all {{ Route::is('empresa_prueba.solicitudes') ? 'bg-blue-600 text-white' : 'hover:bg-gray-700 hover:text-white' }}">
                                <i class="fas fa-list-ol nav-icon text-center text-green-300"></i>
                                <span class="ml-3">Ver Solicitudes</span>
                            </a>
                        @endif
                </nav>
            </div>
